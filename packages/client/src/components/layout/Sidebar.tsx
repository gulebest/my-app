...
export function Sidebar({
   ...
   return (
      <aside
         className={cn(
            'flex h-full w-72 flex-col overflow-hidden border-r border-[var(--app-divider)] bg-[var(--app-sidebar-bg)] p-4 text-(--app-text-strong) sm:p-6',
            className
         )}
      >
         <div className="mb-4 flex flex-none items-center gap-3 sm:mb-6">
         ...
         <div className="app-scroll min-h-0 flex-1 overflow-y-auto pr-1">
            ...
            <div className="border-t border-[var(--app-divider)] pt-5">
         ...
         {currentUser ? (
            <div className="mt-4 flex flex-none items-center gap-3 rounded-xl bg-[var(--app-card-bg)] p-3">
            ...
            <div className="mt-4 flex-none rounded-xl bg-[var(--app-card-bg)] p-3">
